...
with tabs[4]:
    ...
    st.write("This tool searches crt.sh for subdomains of a given domain and then performs HTTP checks to determine if they are online. Searches are dependent on crt.sh and sometimes may fail.")
